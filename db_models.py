...
class estimacion(db.Model):
    ...
    predicted_tipo = db.Column('tipo', db.String(100), nullable=False)
    ...
    def __repr__(self):
        ...
        """
        template_str = '<Prediction [{}]: sepal_length={}, sepal_width={}, petal_length={}, petal_width={}, tipo={}>'
        return template_str.format(
            str(self.Id) if self.Id else 'NOT COMMITED', 
